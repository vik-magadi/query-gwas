...
def plot_variant(connection, var):
    ...
    mydir = "/Users/vmagadi/Documents/Flask"
    output_file(filename = mydir + "/templates/plot_variant_" + var + ".html")
...
def plot_gene(connection, gene):
    ...
    mydir = "/Users/vmagadi/Documents/Flask"
    output_file(filename = mydir + "/templates/plot_gene_" + gene + ".html")
...
def plot_trait(connection, trait):
    ...
    mydir = "/Users/vmagadi/Documents/Flask"
    output_file(filename = mydir + "/templates/plot_trait_" + trait + ".html")
